...
def dividir():
   if(int(numero2.get())==0):
         Label(text="siga participando",font=("Broadway",15),fg="blue").place(x=200,y=160)
...
botonpor = Button(text="multiplicación",command=multiplicar ).place(width=90, x=250,y=120)
